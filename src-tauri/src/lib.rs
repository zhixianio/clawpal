...
use crate::commands::{
    ...
    preview_rollback, preview_session, push_model_profiles_to_local_openclaw,
    ...
    remote_get_ssh_connection_profile, remote_get_status_extra, remote_get_system_status,
    ...
    set_bug_report_settings, set_clawpal_logs_ui_preference,
    set_gateway_logs_ui_preference, set_global_model, set_openclaw_context_ui_preference,
