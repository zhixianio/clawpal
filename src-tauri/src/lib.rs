...
use crate::commands::{
    ...
    fix_issues, get_app_preferences, get_cached_model_catalog, get_cron_runs,
    get_session_model_override, get_session_usage_stats, get_status_extra, get_status_light,
    get_system_status, get_watchdog_status, get_zeroclaw_runtime_target, get_zeroclaw_usage_stats,
    ...
    preview_rollback, preview_session, read_app_log, read_error_log, read_gateway_error_log,
    read_gateway_log, read_raw_config, record_install_experience, refresh_discord_guild_channels,
    ...
    remote_diagnose_primary_via_rescue, remote_extract_model_profiles_from_config,
    remote_fix_issues, remote_get_cron_runs, remote_get_status_extra, remote_get_system_status,
    remote_get_watchdog_status, remote_list_agents_overview, remote_list_backups,
    remote_list_bindings, remote_list_channels_minimal, remote_list_cron_jobs,
    ...
    remote_read_gateway_error_log, remote_read_gateway_log, remote_read_raw_config,
    remote_refresh_model_catalog, remote_repair_primary_via_rescue, remote_resolve_api_keys,
    ...
    remote_write_raw_config, repair_primary_via_rescue, resolve_api_keys, resolve_provider_auth,
    restart_gateway, restore_from_backup, rollback, run_doctor_command, run_openclaw_upgrade,
    set_active_clawpal_data_dir, set_active_openclaw_home, set_agent_model, set_global_model,
    set_rescue_bot_ui_preference, set_session_model_override, set_ssh_transfer_speed_ui_preference,
    ...
    ssh_connect_with_passphrase, ssh_disconnect, ssh_exec, ssh_status, get_ssh_transfer_stats,
    start_watchdog, start_zeroclaw_oauth_login, stop_watchdog, test_model_profile,
    trigger_cron_job, uninstall_watchdog, upsert_model_profile, upsert_ssh_host,
};
