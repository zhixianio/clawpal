...
use crate::commands::{
    ...
    set_rescue_bot_ui_preference, set_session_model_override, set_zeroclaw_doctor_ui_preference,
    ...
    ssh_exec, ssh_status, start_watchdog, start_zeroclaw_oauth_login, stop_watchdog,
    test_model_profile, trigger_cron_job, uninstall_watchdog, upsert_model_profile,
    upsert_ssh_host,
};
