...
use crate::commands::{
    ...
    remote_get_status_extra, remote_get_system_status, remote_get_ssh_connection_profile,
    ...
    set_active_openclaw_home, set_agent_model, set_bug_report_settings, set_global_model,
